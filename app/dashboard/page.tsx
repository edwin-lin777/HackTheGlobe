...
const GUIDE_STEPS = [
  ...
  },
  {
    ...
    docs: ["Enbridge gas bill (account number)", "Proof of income"],
    ...
    <div style={{ marginTop: 28 }}>
      ...
      >
        ...
        <p style={{ fontSize: 12, color: "#92400e", margin: 0 }}>
          <strong>Apply for OESP first</strong> — it unlocks EAP automatically.
          Applying out of order means waiting longer for free upgrades.
        </p>
      </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "17px 20px" }}>
        ...
        >
          <div
            style={{ display: "flex", gap: "5px", flexWrap: "wrap" as const }}
          >
            <span
              style={{
                background: t.bg,
...
function DocumentMasterChecklist({ programs }: { programs: Program[] }) {
  ...
  const perProgramDocs = programs.map((p) => {
    const docsForProgram = p.documents.filter(
      (doc) => (docMap[doc] || []).length === 1,
    );
  ...
  return (
    ...
    >
      ...
      {sharedDocs.length > 0 && (
        <div
          style={{ padding: "10px 18px 12px", borderTop: "1px solid #f3f4f6" }}
        >
          <p
            style={{
              margin: "0 0 6px",
