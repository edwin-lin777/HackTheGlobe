...
const DUMMY: DashboardData = {
  programs: [
    ...
    },
    {
      ...
      type: "retrofit",
      description:
        "The Energy Affordability Program provides free energy-saving upgrades (like insulation or appliances) to help lower long-term electricity use and reduce bills for eligible low-income households. Auto-qualifies with OESP.",
    ...
    },
    {
      ...
      type: "retrofit",
      description:
        "The Enbridge Winterproofing Program provides free home upgrades like insulation and draft proofing to help low-income households stay warm and reduce natural gas heating costs.",
